...
\begin{document}
	...
	\section{Figures}
   	\begin{figure*}[!ht]
		\centering
		\includegraphics[width=0.9\textwidth]{../figures/at_over_gc_2d.png}
	...
	\end{figure*}
   	\begin{figure*}[!ht]
		\centering
		\includegraphics[width=0.9\textwidth]{../figures/diversity_site_codon_2d.png}
	...
	\begin{figure*}[!ht]
		\centering
		\includegraphics[width=0.9\textwidth]{../figures/diversity_seq_codon_2d.png}
	...
	\begin{figure*}[!ht]
		\centering
		\includegraphics[width=0.9\textwidth]{../figures/diversity_site_aa_2d.png}
	...
	\begin{figure*}[!ht]
		\centering
		\includegraphics[width=0.9\textwidth]{../figures/diversity_seq_aa_2d.png}
	...
	\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{../figures/omega_2d.png}
	...
	\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{../figures/omega_SW_2d.png}
...
\end{figure*}
	\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{../figures/omega_WS_2d.png}
	\caption{The expected non-synonymous over synonymous rate, $\operatorname{E} [\omega(\lambda, S)]$, where only mutations from weak nucleotides to strong nucleotides are taken into account, as a function of $\lambda$ and $\alpha$, for the whole sequence}
\end{figure*}
\end{document}
