...
test: all
	...
	build/SimuDiv --preferences data/preferences/gal4.prefs --newick data/trees/mammal_subtree.tre --nuc_matrix data/matrices/nucleotide_GTR.tsv --correlation_matrix data/matrices/correlation3x3.tsv --output test/SimuDiv_gal4
